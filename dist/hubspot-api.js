(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('babel-runtime/core-js/object/assign'), require('babel-runtime/helpers/classCallCheck'), require('babel-runtime/helpers/createClass'), require('babel-runtime/regenerator'), require('babel-runtime/core-js/promise'), require('babel-runtime/helpers/asyncToGenerator'), require('babel-runtime/core-js/json/stringify'), require('babel-runtime/helpers/extends'), require('babel-runtime/core-js/object/keys'), require('querystring'), require('axios'), require('babel-runtime/helpers/defineProperty'), require('fs'), require('form-data'), require('lodash.omit')) :
	typeof define === 'function' && define.amd ? define(['babel-runtime/core-js/object/assign', 'babel-runtime/helpers/classCallCheck', 'babel-runtime/helpers/createClass', 'babel-runtime/regenerator', 'babel-runtime/core-js/promise', 'babel-runtime/helpers/asyncToGenerator', 'babel-runtime/core-js/json/stringify', 'babel-runtime/helpers/extends', 'babel-runtime/core-js/object/keys', 'querystring', 'axios', 'babel-runtime/helpers/defineProperty', 'fs', 'form-data', 'lodash.omit'], factory) :
	(global['hubspot-api'] = factory(global._Object$assign,global._classCallCheck,global._createClass,global._regeneratorRuntime,global._Promise,global._asyncToGenerator,global._JSON$stringify,global._extends,global._Object$keys,global.qs,global.axios,global._defineProperty,global.fs,global.FormData,global.omit));
}(this, (function (_Object$assign,_classCallCheck,_createClass,_regeneratorRuntime,_Promise,_asyncToGenerator,_JSON$stringify,_extends,_Object$keys,qs,axios,_defineProperty,fs,FormData,omit) { 'use strict';
...
var createRequest = (function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(uri, options) {
    ...
    return _regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            properties = _Object$keys(props).reduce(function (acc, curr) {
            ...
            if (props.accessToken) {
              _Object$assign(headers, { Authorization: 'Bearer ' + props.accessToken });
            }
          ...
          case 15:
            ...
            return _context.abrupt('return', _Promise.resolve(response.data));
...
var queryStringParamInterpolator = function queryStringParamInterpolator(objs, original) {
  var response = _Object$keys(objs).map(function (key) {
    if (key && objs[key]) {
      // Remove from the original object
      delete original[key];
      var innerResp = _Object$keys(objs[key]).reduce(function (acc, curr) {
    ...
    _Object$assign(acc, curr);
    return acc;
  }, {});

  return _Object$assign(original, response);
};
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            mergedProps = _Object$assign({}, defaults, _baseOptions);
            _context.next = 5;
            return createRequest(constants.api.account.details, {}, mergedProps);

          case 5:
            accountDetails = _context.sent;
            return _context.abrupt('return', _Promise.resolve(accountDetails));
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 5:
            ...
            return _context2.abrupt('return', _Promise.resolve(dailyLimit));
...
var getById = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(vid) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            mergedProps = _Object$assign({}, defaults$1, _baseOptions$1, options);
            _context.next = 5;
            return createRequest(constants.api.contacts.byId, { vid: vid }, mergedProps);

          case 5:
            contact = _context.sent;
            return _context.abrupt('return', _Promise.resolve(contact));
...
var getByIds = function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 6:
            ...
            return _context2.abrupt('return', _Promise.resolve(allContacts));
  ...
  return function getByIds(_x4) {
    return _ref2.apply(this, arguments);
  };
}();

var getByEmail = function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee3(email, options) {
    var mergedProps, contact;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 5:
            ...
            return _context3.abrupt('return', _Promise.resolve(contact));
...
var getByUtk = function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee4(utk, options) {
    var mergedProps, contact;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 5:
            ...
            return _context4.abrupt('return', _Promise.resolve(contact));
    ...
    return _regeneratorRuntime.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 6:
            body = {
              properties: _Object$keys(obj).map(function (key) {
                return {
                  property: key,
                  value: obj[key]
                };
...
var updateContactByVid = function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee6(vid, properties) {
    var method, body;
    return _regeneratorRuntime.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 5:
            body = {
              properties: _Object$keys(properties).map(function (key) {
                return {
                  property: key,
            ...
            debug$1('updateContactByVid', _JSON$stringify(body));
...
var batchUpdateContacts = function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee7(contactsToUpdate) {
    var method, body;
        ...
        switch (_context7.prev = _context7.next) {
          case 0:
            ...
            body = contactsToUpdate.map(function (contact) {
              ...
              var properties = _Object$keys(contact.updates).map(function (i) {
                return {
                  property: i,
                  value: contact.updates[i]
                };
              });
              return _ref8 = {}, _defineProperty(_ref8, '' + contactType, contact.id), _defineProperty(_ref8, 'properties', properties), _ref8;
            });
            _context7.next = 6;
...
var deleteContact = function () {
  var _ref9 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee8(vid) {
    var method;
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          ...
          case 8:
            ...
            return _context8.abrupt('return', _Promise.reject(_context8.t0));
...
var getContacts = function () {
  var _ref10 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee9(options) {
    var mergedProps, allContacts;
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          ...
          case 5:
            ...
            return _context9.abrupt('return', _Promise.resolve(allContacts));

          case 9:
            _context9.prev = 9;
            _context9.t0 = _context9['catch'](0);
            return _context9.abrupt('return', _Promise.reject(_context9.t0));
      ...
      while (1) {
        switch (_context10.prev = _context10.next) {
          ...
          case 5:
            ...
            return _context10.abrupt('return', _Promise.resolve(recentlyModifiedContacts));

          case 9:
            _context10.prev = 9;
            _context10.t0 = _context10['catch'](0);
            return _context10.abrupt('return', _Promise.reject(_context10.t0.message));
...
var search = function () {
  var _ref12 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee11(q, options) {
      ...
      while (1) {
        switch (_context11.prev = _context11.next) {
          case 0:
            ...
            requiresAuthentication(_baseOptions$1);
            mergedProps = _Object$assign({ q: q }, defaults$1, _baseOptions$1, options);
            _context11.next = 5;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            mergedProps = _Object$assign({}, defaults$2, _baseOptions$2);
            _context.next = 5;
          ...
          case 5:
            ...
            return _context.abrupt('return', _Promise.resolve(_contactsProperties));
        ...
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            body = options.map(function (option) {
              var properties = _Object$keys(option.updates).map(function (i) {
                return {
                  name: i,
...
var getRecentlyModified$1 = function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee6(props) {
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 9:
            ...
            return _context6.abrupt('return', _Promise.resolve(companies));

          case 13:
            _context6.prev = 13;
            _context6.t0 = _context6['catch'](0);
            return _context6.abrupt('return', _Promise.reject(_context6.t0.message));
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          ...
          case 9:
            ...
            return _context7.abrupt('return', _Promise.resolve(companies));

          case 13:
            _context7.prev = 13;
            _context7.t0 = _context7['catch'](0);
            return _context7.abrupt('return', _Promise.reject(_context7.t0.message));
...
var byId = function () {
  var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee8(companyId) {
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          ...
          case 7:
            ...
            return _context8.abrupt('return', _Promise.resolve(companies));

          case 11:
            _context8.prev = 11;
            _context8.t0 = _context8['catch'](0);
            return _context8.abrupt('return', _Promise.reject(_context8.t0.message));
...
var getContacts$1 = function () {
  var _ref9 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee9(companyId) {
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          ...
          case 7:
            ...
            return _context9.abrupt('return', _Promise.resolve(companies));

          case 11:
            _context9.prev = 11;
            _context9.t0 = _context9['catch'](0);
            return _context9.abrupt('return', _Promise.reject(_context9.t0.message));
  ...
  return function getContacts(_x11) {
    return _ref9.apply(this, arguments);
  };
}();

var byDomain = function () {
  var _ref10 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee10(domain, props) {
      ...
      while (1) {
        switch (_context10.prev = _context10.next) {
          ...
          case 14:
            ...
            return _context10.abrupt('return', _Promise.resolve(companies));
...
var events = function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(_ref) {
    var startDate = _ref.startDate,
        ...
        limit = _ref.limit,
        contentCategory = _ref.contentCategory,
        campaignGuid = _ref.campaignGuid,
        includeNoCampaigns = _ref.includeNoCampaigns,
        type = _ref.type;
    ...
    return _regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            mergedProps = _Object$assign({}, defaults$4, _baseOptions$4, {
              startDate: startDate,
              endDate: endDate,
              limit: limit,
            ...
            if (type) {
              _Object$assign(mergedProps, { type: type });
            }
            _context.next = 8;
          ...
          case 8:
            ...
            return _context.abrupt('return', _Promise.resolve(filteredEvents));
...
var getTask = function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2(taskId) {
    ...
    return _regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 5:
            task = _context2.sent;
            return _context2.abrupt('return', _Promise.resolve(task));
    ...
    return _regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 6:
            return _context3.abrupt('return', _Promise.resolve({ msg: 'Task ' + taskId + ' removed' }));
...
var updateTask = function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee4(taskId, _ref5) {
    var eventDate = _ref5.eventDate,
        eventType = _ref5.eventType,
        category = _ref5.category,
        state = _ref5.state,
        campaignGuid = _ref5.campaignGuid,
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 8:
            ...
            return _context4.abrupt('return', _Promise.resolve(updatedTask));
...
var createTask = function () {
  var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee5(_ref7) {
    var eventDate = _ref7.eventDate,
        eventType = _ref7.eventType,
        category = _ref7.category,
        state = _ref7.state,
        campaignGuid = _ref7.campaignGuid,
        contentGroupId = _ref7.contentGroupId,
        topicIds = _ref7.topicIds,
        templatePath = _ref7.templatePath,
        name = _ref7.name,
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            if (!state) {
              _Object$assign(body, { state: 'TODO' });
            }
            if (!eventType) {
              _Object$assign(body, { eventType: 'PUBLISHING_TASK' });
            }
            body = sanitizeObject(body);
          ...
          case 10:
            ...
            return _context5.abrupt('return', _Promise.resolve(filteredEvents));
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            mergedProps = _Object$assign({}, defaults$5, _baseOptions$5, additionalOpts);
            _context.next = 8;
            return createRequest(constants.api.blog.getAll, {}, mergedProps);

          case 8:
            blogPosts = _context.sent;
            return _context.abrupt('return', _Promise.resolve(blogPosts));
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            mergedProps = _Object$assign({}, defaults$5, _baseOptions$5);
            method = 'POST';
            body = {
              email: email,
              fullName: fullName,
            ...
            if (id) {
              ...
              _Object$assign(options, { method: method, id: id });
            }
          ...
          case 11:
            ...
            return _context2.abrupt('return', _Promise.resolve(author));
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 8:
            ...
            return _context3.abrupt('return', _Promise.resolve(authors));
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 5:
            ...
            return _context4.abrupt('return', _Promise.resolve(author));
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 6:
            ...
            return _context6.abrupt('return', _Promise.resolve(authors));
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          ...
          case 6:
            ...
            return _context7.abrupt('return', _Promise.resolve(comments));
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          ...
          case 8:
            ...
            return _context8.abrupt('return', _Promise.resolve(comments));
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          ...
          case 8:
            ...
            return _context9.abrupt('return', _Promise.resolve(topics));
      ...
      while (1) {
        switch (_context10.prev = _context10.next) {
          ...
          case 5:
            ...
            return _context10.abrupt('return', _Promise.resolve(topic));
      ...
      while (1) {
        switch (_context11.prev = _context11.next) {
          ...
          case 8:
            ...
            return _context11.abrupt('return', _Promise.resolve(topics));

          case 12:
            _context11.prev = 12;
            _context11.t0 = _context11['catch'](0);
            return _context11.abrupt('return', _Promise.reject(_context11.t0.message));
      ...
      while (1) {
        switch (_context12.prev = _context12.next) {
          ...
          case 11:
            ...
            return _context12.abrupt('return', _Promise.resolve(update));

          case 15:
            _context12.prev = 15;
            _context12.t0 = _context12['catch'](0);
            return _context12.abrupt('return', _Promise.reject(_context12.t0.message));
      ...
      while (1) {
        switch (_context13.prev = _context13.next) {
          ...
          case 5:
            ...
            return _context13.abrupt('return', _Promise.resolve(comment));

          case 9:
            _context13.prev = 9;
            _context13.t0 = _context13['catch'](0);
            return _context13.abrupt('return', _Promise.reject(_context13.t0.message));
    ...
    return _regeneratorRuntime.wrap(function _callee14$(_context14) {
      while (1) {
        switch (_context14.prev = _context14.next) {
          ...
          case 5:
            return _context14.abrupt('return', _Promise.resolve({ deleted: true }));

          case 8:
            _context14.prev = 8;
            _context14.t0 = _context14['catch'](0);
            return _context14.abrupt('return', _Promise.reject(_context14.t0.message));
    ...
    return _regeneratorRuntime.wrap(function _callee15$(_context15) {
      while (1) {
        switch (_context15.prev = _context15.next) {
          ...
          case 5:
            return _context15.abrupt('return', _Promise.resolve({ restored: true }));

          case 8:
            _context15.prev = 8;
            _context15.t0 = _context15['catch'](0);
            return _context15.abrupt('return', _Promise.reject(_context15.t0.message));
      ...
      while (1) {
        switch (_context16.prev = _context16.next) {
          ...
          case 5:
            ...
            return _context16.abrupt('return', _Promise.resolve(blogInfo));

          case 9:
            _context16.prev = 9;
            _context16.t0 = _context16['catch'](0);
            return _context16.abrupt('return', _Promise.reject(_context16.t0.message));
      ...
      while (1) {
        switch (_context17.prev = _context17.next) {
          ...
          case 8:
            ...
            return _context17.abrupt('return', _Promise.resolve(blogPosts));

          case 12:
            _context17.prev = 12;
            _context17.t0 = _context17['catch'](0);
            return _context17.abrupt('return', _Promise.reject(_context17.t0.message));
      ...
      while (1) {
        switch (_context18.prev = _context18.next) {
          ...
          case 5:
            ...
            return _context18.abrupt('return', _Promise.resolve(blogPosts));

          case 9:
            _context18.prev = 9;
            _context18.t0 = _context18['catch'](0);
            return _context18.abrupt('return', _Promise.reject(_context18.t0.message));
    ...
    return _regeneratorRuntime.wrap(function _callee19$(_context19) {
      while (1) {
        switch (_context19.prev = _context19.next) {
          ...
          case 5:
            return _context19.abrupt('return', _Promise.resolve({ deleted: true }));

          case 8:
            _context19.prev = 8;
            _context19.t0 = _context19['catch'](0);
            return _context19.abrupt('return', _Promise.reject(_context19.t0.message));
    ...
    return _regeneratorRuntime.wrap(function _callee20$(_context20) {
      while (1) {
        switch (_context20.prev = _context20.next) {
          ...
          case 8:
            return _context20.abrupt('return', _Promise.resolve({ cloned: true }));

          case 11:
            _context20.prev = 11;
            _context20.t0 = _context20['catch'](0);
            return _context20.abrupt('return', _Promise.reject(_context20.t0.message));
...
var publishOrSchedulePost = function () {
  var _ref21 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee21(id, action) {
    ...
    return _regeneratorRuntime.wrap(function _callee21$(_context21) {
      while (1) {
        switch (_context21.prev = _context21.next) {
          ...
          case 9:
            return _context21.abrupt('return', _Promise.resolve({ scheduleChanged: true }));

          case 12:
            _context21.prev = 12;
            _context21.t0 = _context21['catch'](0);
            return _context21.abrupt('return', _Promise.reject(_context21.t0.message));
    ...
    return _regeneratorRuntime.wrap(function _callee22$(_context22) {
      while (1) {
        switch (_context22.prev = _context22.next) {
          ...
          case 5:
            return _context22.abrupt('return', _Promise.resolve({ deleted: true }));

          case 8:
            _context22.prev = 8;
            _context22.t0 = _context22['catch'](0);
            return _context22.abrupt('return', _Promise.reject(_context22.t0.message));
      ...
      while (1) {
        switch (_context23.prev = _context23.next) {
          ...
          case 5:
            ...
            return _context23.abrupt('return', _Promise.resolve(buffer));

          case 9:
            _context23.prev = 9;
            _context23.t0 = _context23['catch'](0);
            return _context23.abrupt('return', _Promise.reject(_context23.t0.message));
      ...
      while (1) {
        switch (_context24.prev = _context24.next) {
          ...
          case 5:
            ...
            return _context24.abrupt('return', _Promise.resolve(bufferStatus));

          case 9:
            _context24.prev = 9;
            _context24.t0 = _context24['catch'](0);
            return _context24.abrupt('return', _Promise.reject(_context24.t0.message));
      ...
      while (1) {
        switch (_context25.prev = _context25.next) {
          ...
          case 5:
            ...
            return _context25.abrupt('return', _Promise.resolve(versions));

          case 9:
            _context25.prev = 9;
            _context25.t0 = _context25['catch'](0);
            return _context25.abrupt('return', _Promise.reject(_context25.t0.message));
...
var getPostVersionById = function () {
  var _ref26 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee26(id, version_id) {
      ...
      while (1) {
        switch (_context26.prev = _context26.next) {
          ...
          case 5:
            ...
            return _context26.abrupt('return', _Promise.resolve(version));

          case 9:
            _context26.prev = 9;
            _context26.t0 = _context26['catch'](0);
            return _context26.abrupt('return', _Promise.reject(_context26.t0.message));
...
var restorePostVersionById = function () {
  var _ref27 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee27(id, version_id) {
      ...
      while (1) {
        switch (_context27.prev = _context27.next) {
          ...
          case 7:
            ...
            return _context27.abrupt('return', _Promise.resolve(version));

          case 11:
            _context27.prev = 11;
            _context27.t0 = _context27['catch'](0);
            return _context27.abrupt('return', _Promise.reject(_context27.t0.message));
      ...
      while (1) {
        switch (_context28.prev = _context28.next) {
          ...
          case 5:
            ...
            return _context28.abrupt('return', _Promise.resolve(bufferStatus));

          case 9:
            _context28.prev = 9;
            _context28.t0 = _context28['catch'](0);
            return _context28.abrupt('return', _Promise.reject(_context28.t0.message));
      ...
      while (1) {
        switch (_context29.prev = _context29.next) {
          ...
          case 5:
            ...
            return _context29.abrupt('return', _Promise.resolve(postStatus));

          case 9:
            _context29.prev = 9;
            _context29.t0 = _context29['catch'](0);
            return _context29.abrupt('return', _Promise.reject(_context29.t0.message));
      ...
      while (1) {
        switch (_context30.prev = _context30.next) {
          ...
          case 5:
            ...
            return _context30.abrupt('return', _Promise.resolve(bufferStatus));

          case 9:
            _context30.prev = 9;
            _context30.t0 = _context30['catch'](0);
            return _context30.abrupt('return', _Promise.reject(_context30.t0.message));
      ...
      while (1) {
        switch (_context31.prev = _context31.next) {
          ...
          case 10:
            ...
            return _context31.abrupt('return', _Promise.resolve(buffer));

          case 14:
            _context31.prev = 14;
            _context31.t0 = _context31['catch'](0);
            return _context31.abrupt('return', _Promise.reject(_context31.t0.message));
      ...
      while (1) {
        switch (_context32.prev = _context32.next) {
          ...
          case 11:
            ...
            return _context32.abrupt('return', _Promise.resolve(update));

          case 15:
            _context32.prev = 15;
            _context32.t0 = _context32['catch'](0);
            return _context32.abrupt('return', _Promise.reject(_context32.t0.message));
      ...
      while (1) {
        switch (_context33.prev = _context33.next) {
          ...
          case 8:
            ...
            return _context33.abrupt('return', _Promise.resolve(update));

          case 12:
            _context33.prev = 12;
            _context33.t0 = _context33['catch'](0);
            return _context33.abrupt('return', _Promise.reject(_context33.t0.message));
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            mergedProps = _Object$assign({}, defaults$6, _baseOptions$6);
            method = 'POST';
            _context.next = 8;
          ...
          case 8:
            ...
            return _context.abrupt('return', _Promise.resolve(workflowInfo));
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            return _context2.abrupt('return', _Promise.resolve(workflowInfo));
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 10:
            ...
            return _context4.abrupt('return', _Promise.resolve(workflowInfo));
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 5:
            ...
            return _context5.abrupt('return', _Promise.resolve(allWorkflows));
    ...
    return _regeneratorRuntime.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 7:
            return _context6.abrupt('return', _Promise.resolve({ enrolled: true }));
    ...
    return _regeneratorRuntime.wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          ...
          case 7:
            return _context7.abrupt('return', _Promise.resolve({ unenrolled: true }));
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          ...
          case 5:
            ...
            return _context8.abrupt('return', _Promise.resolve(enrollments));
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          ...
          case 8:
            ...
            return _context9.abrupt('return', _Promise.resolve(eventLogs));
...
var getFilesInFolder = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(folder_id) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            mergedProps = _Object$assign({}, defaults$7, _baseOptions$7, {
              folder_id: folder_id,
              limit: limit,
              offset: offset
            });
          ...
          case 8:
            files = _context.sent;
            return _context.abrupt('return', _Promise.resolve(files));
  ...
  return function getFilesInFolder(_x2) {
    return _ref.apply(this, arguments);
  };
}();
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            mergedProps = _Object$assign({}, defaults$8, _baseOptions$8, additionalOpts);
            _context.next = 8;
            return createRequest(constants.api.domains.getAll, {}, mergedProps);

          case 8:
            domains = _context.sent;
            return _context.abrupt('return', _Promise.resolve(domains));
    ...
    return _regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            mergedProps = _Object$assign({}, defaults$8, _baseOptions$8);
            _context2.next = 7;
            return createRequest(constants.api.domains.byId, { id: id }, mergedProps);

          case 7:
            domainInfo = _context2.sent;
            return _context2.abrupt('return', _Promise.resolve(domainInfo));
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            mergedProps = _Object$assign({}, defaults$9, _baseOptions$9, additionalOpts);
            _context.next = 8;
            return createRequest(constants.api.layouts.getAll, {}, mergedProps);

          case 8:
            layouts = _context.sent;
            return _context.abrupt('return', _Promise.resolve(layouts));
    ...
    return _regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            mergedProps = _Object$assign({}, defaults$9, _baseOptions$9);
            _context2.next = 7;
            return createRequest(constants.api.layouts.byId, { id: id }, mergedProps);

          case 7:
            layoutInfo = _context2.sent;
            return _context2.abrupt('return', _Promise.resolve(layoutInfo));
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 7:
            ...
            return _context3.abrupt('return', _Promise.resolve(layoutBuffer));
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 7:
            ...
            return _context4.abrupt('return', _Promise.resolve(result));
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 7:
            ...
            return _context5.abrupt('return', _Promise.resolve(previousVersions));
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 7:
            ...
            return _context6.abrupt('return', _Promise.resolve(previousVersions));
...
var submitFormV3 = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(portalId, formId) {
    var opts = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
    var method, response;
    return _regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
  ...
  return function submitFormV3(_x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();

var submitForm = function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2(portalId, formId) {
    var opts = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            mergedProps = _Object$assign({
              hs_context: hs_context
            }, defaults$10, _baseOptions$10,
          ...
          case 8:
            return _context2.abrupt('return', _Promise.resolve({ submitted: true }));
...
var getFormFields = function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee3(formId) {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            mergedProps = _Object$assign({}, defaults$10, _baseOptions$10);
            _context3.next = 5;
            return createRequest(constants.api.forms.formFields, { formId: formId }, mergedProps);

          case 5:
            formFields = _context3.sent;
            return _context3.abrupt('return', _Promise.resolve(formFields));
...
var getSubmissions = function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee4(formId) {
    var opts = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            requiresAuthentication(_baseOptions$10);
            mergedProps = _Object$assign({}, defaults$10, _baseOptions$10, opts);
            _context4.next = 5;
            return createRequest(constants.api.forms.submissions, { formId: formId }, mergedProps);

          case 5:
            submissions = _context4.sent;
            return _context4.abrupt('return', _Promise.resolve(submissions));
  ...
  return function getSubmissions(_x9) {
    return _ref4.apply(this, arguments);
  };
}();
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            mergedProps = _Object$assign({}, defaults$11, _baseOptions$11);
            _context.next = 5;
            return createRequest(constants.api.social.channels, {}, mergedProps);

          case 5:
            publishingChannels = _context.sent;
            return _context.abrupt('return', _Promise.resolve(publishingChannels));
    ...
    return _regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 8:
            return _context2.abrupt('return', _Promise.resolve({ status: status, scheduled: true }));
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            mergedProps = _Object$assign({}, defaults$12, _baseOptions$12, {
              offset: offset,
              limit: limit
            });
            _context.next = 6;
          ...
          case 6:
            ...
            return _context.abrupt('return', _Promise.resolve(recentCampaigns));
...
var getCampaign = function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2(campaignId, appId) {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            requiresAuthentication(_baseOptions$12);
            mergedProps = _Object$assign({}, defaults$12, _baseOptions$12, { appId: appId });
            _context2.next = 5;
          ...
          case 5:
            ...
            return _context2.abrupt('return', _Promise.resolve(campaignInfo));
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            limit = opts.limit, offset = opts.offset, properties = opts.properties, propertiesWithHistory = opts.propertiesWithHistory;
            allowedProps = { limit: limit, offset: offset, properties: properties, propertiesWithHistory: propertiesWithHistory };
            mergedProps = _Object$assign({}, defaults$13, _baseOptions$13, allowedProps);
            _context.next = 7;
            return createRequest(constants.api.deals.getAll, {}, mergedProps);

          case 7:
            allDeals = _context.sent;
            return _context.abrupt('return', _Promise.resolve(allDeals));
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            requiresAuthentication(_baseOptions$13);
            mergedProps = _Object$assign({}, defaults$13, _baseOptions$13, options);
            _context2.next = 5;
            return createRequest(constants.api.deals.byId, { id: id }, mergedProps);

          case 5:
            contact = _context2.sent;
            return _context2.abrupt('return', _Promise.resolve(contact));
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 7:
            ...
            return _context3.abrupt('return', _Promise.resolve(recentlyCreatedDeals));
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            requiresAuthentication(_baseOptions$13);
            mergedProps = _Object$assign({}, defaults$13, _baseOptions$13);
          ...
          case 11:
            deal = _context4.sent;
            return _context4.abrupt('return', _Promise.resolve(deal));
...
var batchUpdate$1 = function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee5(updates) {
    ...
    return _regeneratorRuntime.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 7:
            return _context5.abrupt('return', _Promise.resolve({ updated: true }));
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            mergedProps = _Object$assign({}, defaults$14, _baseOptions$14);
            _context.next = 11;
            return createRequest(url, options, mergedProps);

          case 11:
            update = _context.sent;
            return _context.abrupt('return', _Promise.resolve(update));
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            mergedProps = _Object$assign({}, defaults$14, _baseOptions$14, additionalOpts);
            _context2.next = 8;
            return createRequest(constants.api.pages.list, {}, mergedProps);

          case 8:
            pages = _context2.sent;
            return _context2.abrupt('return', _Promise.resolve(pages));
    ...
    return _regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 5:
            page = _context4.sent;
            return _context4.abrupt('return', _Promise.resolve(page));
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 10:
            ...
            return _context5.abrupt('return', _Promise.resolve(buffer));
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 5:
            ...
            return _context6.abrupt('return', _Promise.resolve(buffer));
    ...
    return _regeneratorRuntime.wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          ...
          case 6:
            return _context7.abrupt('return', _Promise.resolve({ cloned: true }));
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          ...
          case 5:
            ...
            return _context8.abrupt('return', _Promise.resolve(bufferedChanges));
...
var doPublishAction = function () {
  var _ref9 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee9(id, action) {
    var mergedProps, body, method;
    return _regeneratorRuntime.wrap(function _callee9$(_context9) {
      while (1) {
        switch (_context9.prev = _context9.next) {
          ...
          case 7:
            return _context9.abrupt('return', _Promise.resolve({ success: true, action: action }));
    ...
    return _regeneratorRuntime.wrap(function _callee10$(_context10) {
      while (1) {
        switch (_context10.prev = _context10.next) {
          ...
          case 5:
            return _context10.abrupt('return', _Promise.resolve({ success: true }));
    ...
    return _regeneratorRuntime.wrap(function _callee11$(_context11) {
      while (1) {
        switch (_context11.prev = _context11.next) {
          ...
          case 5:
            return _context11.abrupt('return', _Promise.resolve({ success: true }));
    ...
    return _regeneratorRuntime.wrap(function _callee12$(_context12) {
      while (1) {
        switch (_context12.prev = _context12.next) {
          ...
          case 5:
            return _context12.abrupt('return', _Promise.resolve({ success: true }));
      ...
      while (1) {
        switch (_context13.prev = _context13.next) {
          ...
          case 5:
            ...
            return _context13.abrupt('return', _Promise.resolve(versions));
...
var restorePageVersion = function () {
  var _ref14 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee14(id, version_id) {
      ...
      while (1) {
        switch (_context14.prev = _context14.next) {
          ...
          case 7:
            ...
            return _context14.abrupt('return', _Promise.resolve(versions));
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            options = { method: method, body: body };
            mergedProps = _Object$assign({}, defaults$15, _baseOptions$15);
            _context.next = 10;
            return createRequest(url, options, mergedProps);

          case 10:
            create = _context.sent;
            return _context.abrupt('return', _Promise.resolve(create));
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 5:
            ...
            return _context2.abrupt('return', _Promise.resolve(tables));
...
var getTableRows = function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee3(tableId, portalId) {
    var opts = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            mergedProps = _Object$assign({}, defaults$15, _baseOptions$15, opts, additionalOpts);
            _context3.next = 5;
            return createRequest(constants.api.hubdb.rows, { tableId: tableId }, mergedProps);

          case 5:
            rows = _context3.sent;
            return _context3.abrupt('return', _Promise.resolve({ published: true, rows: rows }));
  ...
  return function getTableRows(_x3, _x4) {
    return _ref3.apply(this, arguments);
  };
}();

var publishTable = function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee4(tableId) {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 6:
            ...
            return _context4.abrupt('return', _Promise.resolve(table));
...
var getTableById = function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee5(tableId, portalId) {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.prev = 0;
            additionalOpts = { portalId: portalId };
            mergedProps = _Object$assign({}, defaults$15, _baseOptions$15, options, additionalOpts);
            _context5.next = 5;
            return createRequest(constants.api.hubdb.table, { tableId: tableId }, mergedProps);

          case 5:
            table = _context5.sent;
            return _context5.abrupt('return', _Promise.resolve(table));
  ...
  return function getTableById(_x7, _x8) {
    return _ref5.apply(this, arguments);
  };
}();

var addTableRow = function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee6(tableId) {
    ...
    return _regeneratorRuntime.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 8:
            add = _context6.sent;
            return _context6.abrupt('return', _Promise.resolve(add));
  ...
  return function addTableRow(_x10) {
    return _ref6.apply(this, arguments);
  };
}();

var updateTableRow = function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee7(tableId, rowId) {
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          ...
          case 8:
            ...
            return _context7.abrupt('return', _Promise.resolve(update));
  ...
  return function updateTableRow(_x12, _x13) {
    return _ref7.apply(this, arguments);
  };
}();

var deleteTableRow = function () {
  var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee8(tableId, rowId) {
    var body = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
    var method, url, options, mergedProps, update;
    return _regeneratorRuntime.wrap(function _callee8$(_context8) {
      while (1) {
        switch (_context8.prev = _context8.next) {
          ...
          case 8:
            ...
            return _context8.abrupt('return', _Promise.resolve(update));
  ...
  return function deleteTableRow(_x15, _x16) {
    return _ref8.apply(this, arguments);
  };
}();
    ...
    return _regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            info = _context.sent;
            return _context.abrupt('return', _Promise.resolve(info));
...
var getById$2 = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(listId) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            mergedProps = _Object$assign({}, _baseOptions$17);
            _context.next = 5;
            return createRequest(constants.api.contactsList.byId, { listId: listId }, mergedProps);

          case 5:
            list = _context.sent;
            return _context.abrupt('return', _Promise.resolve(list));
...
var getContactsInList = function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2(listId) {
    var opts = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  ...
  return function getContactsInList(_x3) {
    return _ref2.apply(this, arguments);
  };
}();
...
var updateEmailSubscription = function () {
    ...
    return _regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            mergedProps = _extends({}, defaults$18, _baseOptions$18);
            _context.next = 7;
          ...
          case 7:
            ...
            return _context.abrupt('return', _Promise.resolve(updateStatus));
  ...
  return function updateEmailSubscription(_x2) {
    return _ref.apply(this, arguments);
  };
}();

var getEmailSubscriptionStatus = function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2(email, portalId) {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            return _context2.abrupt('return', _Promise.resolve(status));
...
var getById$3 = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(objectId, definitionId) {
    var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            mergedProps = _Object$assign({}, defaults$19, _baseOptions$19, options);
            _context.next = 5;
            return createRequest(constants.api.associations.byId, { objectId: objectId, definitionId: definitionId }, mergedProps);

          case 5:
            products = _context.sent;
            return _context.abrupt('return', _Promise.resolve(products));
...
var getLineItemByIds = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(ids) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            mergedProps = _Object$assign({}, defaults$20, _baseOptions$20, options);
            _context.next = 7;
  ...
  return function getLineItemByIds(_x2) {
    return _ref.apply(this, arguments);
  };
}();
...
var getById$4 = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(ownerId) {
    var mergedProps, contact;
    return _regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            mergedProps = _Object$assign({}, defaults$21, _baseOptions$21);
            _context.next = 5;
...
var createProducts = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(newProducts) {
    ...
    return _regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            return _context.abrupt('return', _Promise.resolve({ deleted: true }));
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 8:
            ...
            return _context2.abrupt('return', _Promise.resolve(result));
...
var HubSpotClient = function () {
  ...
  function HubSpotClient(props) {
    _classCallCheck(this, HubSpotClient);

    _Object$assign(this, { props: props });
  }
  /**
